<script setup>
// Mapa reutilizable. El scroll de la página sigue funcionando aunque el cursor esté sobre el mapa.
...
onMounted(async()=>{
    ...
    // El zoom con rueda se desactiva para que el mapa no atrape el scroll de la página.
    map=L.map(mapEl.value,{zoomControl:true,scrollWheelZoom:false}).setView([13.72,-89.2],8);
