...
<template>
    <!-- En celular se eliminó la barra superior; la navegación queda solamente abajo. -->
    ...
    <!-- Menú principal para celular y tableta. -->
    <nav
    ...
    >
        <div class="mx-auto grid max-w-md grid-cols-4">
            <button
                ...
                :key="item.key"
                type="button"
                class="flex min-h-[62px] flex-col items-center justify-center gap-1 px-1 text-white transition"
