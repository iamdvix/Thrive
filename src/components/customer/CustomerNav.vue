<script setup>
// Botones principales del cliente. En computadora no dependen de una barra contenedora.
...
<template>
<nav class="hidden items-center gap-2 overflow-x-auto pb-1 lg:flex [scrollbar-width:none] [&::-webkit-scrollbar]:hidden" aria-label="Navegación del cliente">
...
<nav class="fixed inset-x-0 bottom-0 z-50 overflow-hidden rounded-t-[26px] border-t border-white/20 bg-[#00B4D8] shadow-[0_-8px_24px_rgba(0,0,0,.14)] lg:hidden" aria-label="Navegación móvil del cliente">
