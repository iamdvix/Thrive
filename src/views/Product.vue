...
// En celular se puede cambiar de foto deslizando, sin mostrar miniaturas.
        ...
        <div class="grid gap-4 lg:grid-cols-[1.08fr_.92fr] lg:items-start">
            ...
            <section class="bg-white sm:rounded-[28px] sm:border sm:border-gray-200 sm:p-4">
                <div class="relative overflow-hidden bg-gray-100 sm:rounded-[23px]">
                    ...
                    <div class="relative h-[390px] w-full overflow-hidden bg-gray-100 sm:h-[460px] lg:h-[560px] lg:rounded-[26px]" @touchstart.passive="handleTouchStart" @touchend.passive="handleTouchEnd">
