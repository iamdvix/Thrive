...
<div class="min-h-screen bg-[#F8FBFC] pb-[76px] text-gray-700 lg:pb-0">
    ...
    >
        ...
        >
            <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-[20px] bg-[#CAF0F8] text-[#0077B6]">
        ...
        >
            <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-[20px] bg-[#CAF0F8] text-[#0077B6]">
                <svg class="h-8 w-8" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                    <path stroke-linecap="round" d="M5 18V8a7 7 0 0114 0v10"></path>
